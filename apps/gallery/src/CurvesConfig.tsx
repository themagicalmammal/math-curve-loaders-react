...
export const GLOBAL_CONTROLS: ControlDef[] = [
  {
    ...
    label: "Particles",
    description:
      "Number of particles in the animated trail — more creates a denser, fuller trail.",
    min: 24,
    max: 140,
    step: 1,
    section: "visual",
  },
  {
    ...
    label: "Trail",
    description:
      "How long the particle trail appears — longer trails create smoother, more continuous paths.",
    min: 0.12,
    max: 0.68,
    step: 0.01,
    section: "visual",
  },
  {
    ...
    label: "Loop",
    description:
      "Duration of one full animation loop cycle — controls the overall animation speed.",
    min: 2400,
    max: 12000,
    step: 100,
    section: "visual",
  },
  {
    ...
    label: "Pulse",
    description:
      "Speed of the breathing/pulse modulation — how fast the shape expands and contracts.",
    min: 1800,
    max: 10000,
    step: 100,
    section: "visual",
    ...
    controls: [
      {
        key: "baseRadius",
        label: "Base radius",
        description: "Radius of the base circle that the curve orbits around.",
        min: 4,
        max: 10,
        step: 0.1,
        section: "formula",
      },
      {
        ...
        label: "Detail",
        description:
          "Amplitude of the inner cosine term that carves the petal details.",
        min: 1,
        max: 5,
        step: 0.1,
        section: "formula",
      },
      {
        ...
        label: "Petals",
        description:
          "Number of petals or lobes in the rose curve — higher values create denser patterns.",
        min: 3,
        max: 12,
        step: 1,
        section: "formula",
      },
      {
        ...
        label: "Scale",
        description:
          "Overall scaling factor for the curve — larger values stretch the curve wider.",
        min: 2.5,
        max: 5.5,
        step: 0.1,
        section: "formula",
...
s = ε(t)`,
  ...
  },
  {
    ...
    tag: "r = cos(kθ)",
    description:
      "The radius expands and contracts with cos(7t), so the orbit breathes as it spins.",
    component: RoseOrbit,
    color: "#d946ef",
...
y(t) = r(t) × sin(t) × 3.3 + 50`,
    ...
    controls: [
      {
        key: "orbitRadius",
        label: "Base radius",
        description: "Base radius of the orbiting rose curve.",
        min: 4,
        max: 10,
        step: 0.1,
      },
      {
        ...
        label: "Detail",
        description:
          "Amplitude of the modulating cosine that creates the petal shape.",
        min: 1,
        max: 5,
        step: 0.1,
      },
      {
        ...
        label: "k",
        description:
          "The k parameter in cos(kθ) — controls the number of lobes.",
        min: 3,
        max: 12,
        step: 1,
      },
      {
        key: "curveScale",
        label: "Scale",
        description: "Overall scaling factor for the curve.",
        min: 2.5,
        max: 5.5,
        step: 0.1,
      },
  ...
  },
  {
    ...
    tag: "r = a cos(kθ)",
    description:
      "Using r = a cos(5t) creates five evenly spaced lobes, the breathing modulation gives them a living pulse.",
    component: RoseCurve,
    color: "#ec4899",
...
y(t) = r(t) × sin(t) × roseScale + 50`,
    ...
    controls: [
      {
        ...
        label: "a",
        description:
          'The "a" parameter in r = a cos(kθ) — sets the base size of the rose.',
        min: 5,
        max: 14,
        step: 0.1,
        section: "formula",
      },
      {
        ...
        label: "a boost",
        description:
          'Sinusoidal modulation on "a" — adds organic variation to the radius.',
        min: 0,
        max: 2,
        step: 0.05,
        section: "formula",
      },
      {
        ...
        label: "Base pulse",
        description:
          "Base breathing value — the minimum scale of the pulse animation.",
        min: 0.3,
        max: 1.2,
        step: 0.01,
        section: "formula",
      },
      {
        ...
        label: "Pulse boost",
        description:
          "Amplitude of the breathing pulse — how much the shape expands and contracts.",
        min: 0,
        max: 0.8,
        step: 0.01,
        section: "formula",
      },
      {
        ...
        label: "k",
        description:
          'The "k" parameter in r = a cos(kθ) — controls the number of lobes.',
        min: 2,
        max: 10,
        step: 1,
        section: "formula",
  ...
  },
  {
    ...
    tag: "r = a cos(2θ)",
    description:
      "With k = 2, the cosine radius forms broad opposing petals, the breathing adds life.",
    component: RoseTwo,
    color: "#f43f5e",
...
y(t) = r(t) × sin(t) × roseScale + 50`,
  ...
  },
  {
    ...
    tag: "r = a cos(3θ)",
    description:
      "With k = 3, the curve resolves into three rotating petals, the breathing modulation gives a living pulse.",
    component: RoseThree,
    color: "#ef4444",
...
y(t) = r(t) × sin(t) × roseScale + 50`,
  ...
  },
  {
    ...
    tag: "r = a cos(4θ)",
    description:
      "With k = 4, the petals settle into a balanced cross-like rose, the breathing gives it life.",
    component: RoseFour,
    color: "#f97316",
...
y(t) = r(t) × sin(t) × roseScale + 50`,
  ...
  },
  {
    ...
    description:
      "Different sine frequencies on x and y make the path cross itself, creating drift patterns.",
...
y(t) = x(t) × sin(lissajousBY × t) + 50`,
    ...
    controls: [
      {
        ...
        label: "Amplitude",
        description:
          "Base amplitude of the Lissajous curve — controls the overall size.",
        min: 8,
        max: 36,
        step: 0.5,
        section: "formula",
      },
      {
        ...
        label: "Amp pulse",
        description:
          "Pulsing modulation on the amplitude — adds a breathing effect.",
        min: 0,
        max: 12,
        step: 0.1,
        section: "formula",
      },
      {
        key: "lissajousAX",
        label: "a",
        description: 'Frequency parameter "a" for the x-axis sine wave.',
        min: 1,
        max: 8,
        step: 1,
        section: "formula",
      },
      {
        key: "lissajousBY",
        label: "b",
        description: 'Frequency parameter "b" for the y-axis sine wave.',
        min: 1,
        max: 8,
        step: 1,
        section: "formula",
      },
      {
        ...
        label: "Y scale",
        description:
          "Vertical scaling factor — stretches or compresses the y-axis.",
        min: 0.4,
        max: 1.4,
        step: 0.01,
        section: "formula",
  ...
  },
  {
    ...
    description:
      "The 1 + sin²t denominator pinches the center while preserving the figure-eight shape, creating a blooming infinity symbol.",
...
y(t) = r(t) × sin(t) + 50`,
    ...
    controls: [
      {
        ...
        label: "a",
        description:
          'The "a" parameter of the Bernoulli lemniscate — sets the size of the figure-eight.',
        min: 8,
        max: 30,
        step: 0.5,
        section: "formula",
      },
      {
        ...
        label: "Pulse",
        description:
          "Sinusoidal pulse added to the radius — creates the blooming animation.",
        min: 0,
        max: 12,
        step: 0.1,
        section: "formula",
  ...
  },
  {
    ...
    description:
      "The rolling-circle terms create nested turns and offsets, so the trail draws spirograph-style loops.",
...
y' = (y + spirodBoost × sin(pulseTime)) × spiroScale + 50`,
    ...
    controls: [
      {
        ...
        label: "R",
        description:
          "Radius of the fixed outer circle in the rolling-circle spirograph.",
        min: 4,
        max: 12,
        step: 0.1,
        section: "formula",
      },
      {
        ...
        label: "r",
        description:
          "Radius of the rolling inner circle — together with R determines the pattern.",
        min: 1,
        max: 5,
        step: 0.1,
        section: "formula",
      },
      {
        ...
        label: "d",
        description:
          "Distance of the drawing point from the center of the rolling circle.",
        min: 1,
        max: 8,
        step: 0.1,
        section: "formula",
      },
      {
        key: "spiroScale",
        label: "Scale",
        description: "Overall scaling factor for the spirograph.",
        min: 1.5,
        max: 4.5,
        step: 0.05,
        section: "formula",
  ...
  },
  {
    ...
    tag: "R = 3, r = 1, d = 3",
    description:
      "This rolling-circle setup resolves into three large looping petals, the breathing adds a gentle pulse.",
...
y' = y × spiralScale + 50`,
    ...
    controls: [
      ...
      },
      {
        ...
        label: "d",
        description:
          "Distance of the drawing point from the rolling circle center.",
        min: 1,
        max: 5,
        step: 0.1,
        section: "formula",
      ...
      },
      {
        ...
        label: "Pulse",
        description:
          "Breathing modulation amplitude on the y-axis — adds a living pulse.",
        min: 0,
        max: 1,
        step: 0.05,
        section: "formula",
  ...
  },
  {
    ...
    tag: "R = 4, r = 1, d = 3",
    description:
      "Four-lobe spirograph pattern from R=4, r=1, d=3 — the breathing adds life to each petal.",
...
y' = y × spiralScale + 50`,
  ...
  },
  {
    ...
    tag: "R = 5, r = 1, d = 3",
    description:
      "Five-fold spirograph spiral — the breathing modulation gives each petal a living pulse.",
...
y' = y × spiralScale + 50`,
  ...
  },
  {
    ...
    tag: "R = 6, r = 1, d = 3",
    description:
      "Six-fold spirograph spiral — dense, symmetrical, with breathing modulation.",
...
y' = y × spiralScale + 50`,
  ...
  },
  {
    ...
    tag: "Butterfly Curve",
    description:
      "A rich butterfly curve with exponential decay creating delicate wings — phase animation adds depth.",
...
pulse = 1 + butterflyPulse × sin(pulseTime)`,
    ...
    controls: [
      {
        ...
        label: "Turns",
        description:
          "Number of turns in the butterfly wing pattern — higher values add more detail.",
        min: 6,
        max: 18,
        step: 0.5,
        section: "formula",
      },
      {
        key: "butterflyScale",
        label: "Scale",
        description: "Overall scaling factor for the butterfly curve.",
        min: 2.5,
        max: 7,
        step: 0.05,
        section: "formula",
      },
      {
        ...
        label: "Pulse",
        description:
          "Breathing modulation amplitude — how much the butterfly expands and contracts.",
        min: 0,
        max: 1.2,
        step: 0.01,
        section: "formula",
      },
      {
        ...
        label: "Cos weight",
        description:
          "Weight of the secondary cosine term — controls wing complexity.",
        min: 0.5,
        max: 4,
        step: 0.05,
        section: "formula",
      },
      {
        ...
        label: "Power",
        description:
          "Power of the inner cosine modulation — affects wing pattern density.",
        min: 2,
        max: 8,
        step: 1,
        section: "formula",
  ...
  },
  {
    ...
    tag: "Cardioid",
    description:
      "A heart-shaped cardioid curve with breathing glow — the pulse modulation gives it life.",
...
y(t) = r(t) × sin t × cardioidScale + 50`,
    ...
    controls: [
      {
        ...
        label: "a",
        description:
          'The "a" parameter in the cardioid equation — sets the base size.',
        min: 4,
        max: 14,
        step: 0.1,
        section: "formula",
      },
      {
        ...
        label: "Pulse",
        description:
          "Amplitude of the breathing pulse — how much the cardioid expands and contracts.",
        min: 0,
        max: 2,
        step: 0.05,
        section: "formula",
      },
      {
        key: "cardioidScale",
        label: "Scale",
        description: "Overall scaling factor for the cardioid.",
        min: 1,
        max: 3.5,
        step: 0.05,
        section: "formula",
  ...
  },
  {
    ...
    tag: "r = a(1+cosθ)",
    description:
      "The classic cardioid heart shape — the breathing adds a gentle pulse.",
...
y(t) = r(t) × sin t × cardioidScale + 50`,
    ...
    controls: [
      {
        ...
        label: "a",
        description:
          'The "a" parameter in r = a(1+cosθ) — sets the size of the heart.',
        min: 4,
        max: 14,
        step: 0.1,
      },
      {
        ...
        label: "Pulse",
        description:
          "Amplitude of the breathing pulse — how much the heart expands and contracts.",
        min: 0,
        max: 2,
        step: 0.05,
      },
  ...
  },
  {
    ...
    tag: "f(x) Heart Wave",
    description:
      "A wavy heart-shaped curve drawn by a parametric function — the wave amplitude adds organic motion.",
    component: HeartWave,
    color: "#e11d48",
...
y(t) = (heartWaveB × cos(t) - heartWaveB × sin(t) - 2 × cos(t) - √(|cos(t)|)) × heartWaveAmp × heartWaveScaleY + 50`,
    ...
    controls: [
      {
        key: "heartWaveB",
        label: "b",
        description: 'The "b" parameter — scales the heart wave amplitude.',
        min: 2,
        max: 12,
        step: 0.1,
        section: "formula",
      },
      {
        ...
        label: "Root span",
        description:
          "Span of the square root term — controls the heart tip sharpness.",
        min: 2.2,
        max: 4.2,
        step: 0.05,
        section: "formula",
      },
      {
        ...
        label: "Wave amp",
        description:
          "Amplitude of the wave modulation — adds organic wavy motion.",
        min: 0.3,
        max: 1.6,
        step: 0.05,
        section: "formula",
  ...
  },
  {
    ...
    description:
      "An expanding Archimedean spiral that sweeps outward — the pulse adds breathing motion to the turns.",
...
y(t) = r(t) × sin(t) × searchScale + 50`,
    ...
    controls: [
      {
        ...
        label: "Turns",
        description:
          "Number of spiral turns — more turns create a denser spiral.",
        min: 2,
        max: 8,
        step: 0.1,
        section: "formula",
      },
      {
        ...
        label: "Base radius",
        description: "Inner starting radius of the spiral.",
        min: 2,
        max: 16,
        step: 0.1,
        section: "formula",
      },
      {
        key: "searchRadiusAmp",
        label: "Radius amp",
        description: "Rate at which the radius expands per turn.",
        min: 2,
        max: 16,
        step: 0.1,
        section: "formula",
      },
      {
        ...
        label: "Pulse",
        description:
          "Breathing modulation on the radius — adds a living pulse to the spiral.",
        min: 0,
        max: 6,
        step: 0.1,
        section: "formula",
      },
      {
        key: "searchScale",
        label: "Scale",
        description: "Overall scaling factor for the spiral.",
        min: 0.5,
        max: 1.8,
        step: 0.05,
        section: "formula",
  ...
  },
  {
    ...
    tag: "Fourier Curve",
    description:
      "A sum of sine and cosine terms creating a complex flowing shape — the mix pulse modulates the phase.",
    ...
    controls: [
      {
        ...
        label: "x cos1",
        description:
          "Coefficient of cos(t) in the x equation — primary horizontal harmonic.",
        min: 4,
        max: 24,
        step: 0.1,
        section: "formula",
      },
      {
        ...
        label: "x cos3",
        description:
          "Coefficient of cos(3t) in the x equation — third harmonic.",
        min: 0,
        max: 14,
        step: 0.1,
        section: "formula",
      },
      {
        ...
        label: "x sin5",
        description:
          "Coefficient of sin(5t) in the x equation — fifth harmonic.",
        min: 0,
        max: 10,
        step: 0.1,
        section: "formula",
      },
      {
        ...
        label: "y sin1",
        description:
          "Coefficient of sin(t) in the y equation — primary vertical harmonic.",
        min: 4,
        max: 24,
        step: 0.1,
        section: "formula",
      },
      {
        ...
        label: "y sin2",
        description:
          "Coefficient of sin(2t) in the y equation — second harmonic.",
        min: 0,
        max: 14,
        step: 0.1,
        section: "formula",
      },
      {
        ...
        label: "y cos4",
        description:
          "Coefficient of cos(4t) in the y equation — fourth harmonic.",
        min: 0,
        max: 10,
        step: 0.1,
        section: "formula",
      },
      {
        ...
        label: "Mix pulse",
        description:
          "Phase modulation pulse — adds organic variation to the shape.",
        min: 0,
        max: 0.8,
        step: 0.01,
        section: "formula",
